...
const SUITES = [
  ...
  { name: "sims/quantity-selector", dir: "sims", base: "quantity-selector" },
  { name: "sims/quantity-sync", dir: "sims", base: "quantity-sync" },
  { name: "sims/volume-function", dir: "sims", base: "volume-function" },
];
